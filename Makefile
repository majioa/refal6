...
sources = arithm.c channel.c class.c concha.c conmask.c constor.c constr.c contain.c convect.c fileio.c nomouse.c novideo.c rbarm.c rbclass.c rbcont.c rbeval.c rbio.c rbsys.c rbtable.c refgen.c refini.c rfalloc.c rfarm.c rfinter.c rfserv.c rfstor.c rfelst.c rfgo.c rfinit.c rfinp.c rfmain.c rfoutp.c rftable.c conio.c
#sources = $(wildcard *.c)
objects = $(patsubst %.c,%.o,$(sources))

CFLAGS = -c -std=c11 -Werror
LDFLAGS = -lncurses -lm
